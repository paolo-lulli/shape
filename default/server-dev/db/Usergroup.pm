...
my $create_Usergroup_query= " create table Usergroup(  
	ID char(36)
	, created date
	, name varchar(256)
	, updated date
...
sub create_Usergroup(){
       	&launch_query($create_Usergroup_query);
}
...
my $updated = $_[3];
my $description = $_[4];
my $sql = "insert into Usergroup values ( '$ID', '$created', '$name', '$updated', '$description' )";
